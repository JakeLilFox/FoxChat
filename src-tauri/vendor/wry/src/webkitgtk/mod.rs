...
impl InnerWebView {
  ...
  fn create_webview(
    ...
    // WebRTC is a construction-time feature in WebKitGTK. Supplying these
    // settings to the builder makes RTCPeerConnection available to the first
    // document, while permissions are still handled by the application.
